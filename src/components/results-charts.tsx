...
const recallDelta: Record<string, Record<string, number | null>> = {
  ...
  "Exp C4 (SD 3.5)": { akiec: null, bcc: null, bkl: null, df: null, mel: null, nv: null, vasc: null },
};
...
const overallMetrics = [
  {
    ...
    "Exp C4 (SD 3.5)": "-" as string | number,
  },
  {
    metric: "Macro F1",
  ...
  return (
    <div ref={ref}>
      ...
      <p className="text-xs text-zinc-500 text-center mt-2">
        Exp C4 (SD 3.5): data not yet available
      </p>
    </div>
  );
}
  ...
  return (
    <div ref={ref}>
      ...
      <div className="mt-4 flex flex-wrap gap-3 justify-center">
        ...
        <span className="text-xs text-sky-400/60 bg-sky-500/5 rounded px-3 py-1">
          Exp C4 (SD 3.5): pending
        </span>
      </div>
    </div>
  );
