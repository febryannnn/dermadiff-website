    ...
    <>
      ...
      <Section className="border-t border-border/40">
        <SectionHeader
          ...
          title="Real vs Synthetic Samples"
          description="Side-by-side comparison of original dermoscopic images from HAM10000 and synthetic images generated by each Stable Diffusion variant across all five minority lesion classes."
        />
        <motion.div {...fadeIn(0)}>
          <RealVsSynthetic />
        </motion.div>
